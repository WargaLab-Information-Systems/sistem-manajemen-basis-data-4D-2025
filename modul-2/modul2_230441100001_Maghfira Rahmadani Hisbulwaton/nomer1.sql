...
MODIFY COLUMN id_kategori INT AUTO_INCREMENT;

ALTER TABLE skala_umkm
MODIFY COLUMN id_skala INT AUTO_INCREMENT;

ALTER TABLE kabupaten_kota
MODIFY COLUMN id_kabupaten_kota INT AUTO_INCREMENT;

ALTER TABLE pemilik_umkm
MODIFY COLUMN id_pemilik INT AUTO_INCREMENT;

ALTER TABLE umkm
MODIFY COLUMN id_umkm INT AUTO_INCREMENT;

ALTER TABLE produk_umkm
MODIFY COLUMN id_produk INT AUTO_INCREMENT;
...
('Kota Banjar'), ('Kabupaten Bandung'), ('Kabupaten Bandung Barat'), ('Kabupaten Bekasi'),
...
JOIN 
    ...
    pemilik_umkm p ON u.id_pemilik = p.id_pemilik

JOIN 

    kategori_umkm k ON u.id_kategori = k.id_kategori

JOIN 

    skala_umkm s ON u.id_skala = s.id_skala

JOIN 

    kabupaten_kota kab ON u.id_kabupaten_kota = kab.id_kabupaten_kota;
...
JOIN 
    ...
    produk_umkm p ON u.id_umkm = p.id_umkm;
...
LEFT JOIN 
    ...
    umkm u ON kab.id_kabupaten_kota = u.id_kabupaten_kota
